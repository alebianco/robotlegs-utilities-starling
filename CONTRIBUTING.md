# Contributing to RoboStarlegs

♥ [RoboStarlegs](https://github.com/alebianco/robotlegs-extension-starling) and want to get involved?
...
**[File a bug report](https://github.com/alebianco/robotlegs-extension-starling/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/robotlegs-extension-starling.git
   # Navigate to the newly cloned directory
   cd robotlegs-extension-starling
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/alebianco/robotlegs-extension-starling.git
   ```
